...
module.exports = (function() {
  var Controller = function(params) {
    ...
    this.getMulterAccept = function() {
      if (multerAccept == null) multerAccept = multer(multerConfig);
      return multerAccept;
    };
        ...
        return new Promise(function(resolve) {
          ...
          multerAccept(req, res, function(err) {
            if (err) {
              ...
              bundle.addPart('file', 'file', req.file);
    ...
    this.handleRequest = function(req, res) {
      ...
      chain.push(self.addEndpointName(endpointName));
      chain.push(self.addParams(params));
